...
public class SoundRecordAndAnalysisActivity extends Activity implements OnClickListener{
    ...
    public final static int ID_BITMAPDISPLAYSPECTRUM = 1;
    public final static int ID_IMAGEVIEWSCALE = 2;
        ...
        protected Boolean doInBackground(Void... params) {
            ...
            while (started) {
                ...
                if (isCancelled() || (CANCELLED_FLAG == true)) {
                    ...
                    freq = calculate(1000,buffer);

                    Log.d("FREQUENCY", String.format("EAN-8: %d", freq));
                    if( freq >=180)
                    {
                        runOnUiThread(new Runnable() {
                            @Override
                            public void run() {
                                startStopButton.setText("balleee");
                            }
                        });
                        Log.d("NAVAL","YO YO hopNEY SINMG ");
                    }
